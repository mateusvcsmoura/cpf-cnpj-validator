  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(ev) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ev.preventDefault();
          resultCpf = document.querySelector('#resultCpf');
        ...
        case 5:
          ...
          _context.next = 8;
          return fetch('/validateCpf', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/x-www-form-urlencoded'
            },
            body: "cpf=".concat(encodeURIComponent(cpf))
          });
        case 8:
...
cnpjBtn.addEventListener('click', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(ev) {
    var resultCnpj, cnpj, response, text;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ev.preventDefault();
          resultCnpj = document.querySelector('#resultCnpj');
        ...
        case 5:
          ...
          _context2.next = 8;
          return fetch('/validateCnpj', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/x-www-form-urlencoded'
            },
            body: "cnpj=".concat(encodeURIComponent(cnpj))
          });
        case 8:
